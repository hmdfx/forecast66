...
class Models extends CI_Model {
    ...
    public function GetAllRawMaterial(){
        $this->db->select('a.id, a.code, a.label, a.id_category, a.countries, a.created_at, a.created_by, a.updated_at, a.updated_by, b.label as category, c.label as country_name');
